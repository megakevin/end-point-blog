...
19. Favor shallow hierarchies instead of deep ones. Narrow is also preferable to wide. Wide ones are easier to live with as long as they are also shallow. But deep and wide ones are a maintenance nightmare. That is, keep the vertical levels of inheritance as low as you can. hierarchies where a class inherits from another, which inherits from another, which also inherits from another, are hard to understand and maintain.
